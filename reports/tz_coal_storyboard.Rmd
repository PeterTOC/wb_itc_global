...
lines(inter, lwd=1.5, col="yellow")    
}
...
### The cost of producing coal has gone up over the years
...
### These two variables showed a high correlation of `r cor(clean_coal$coal_rent_pct_of_gdp, clean_coal$natural_capital)` throughout the years
